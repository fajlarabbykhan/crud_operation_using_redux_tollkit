...
const Home = () => {
    return (
        <div>
            <div className="hero min-h-screen bg-red-10">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        <h1 className="text-5xl font-bold">Hello there</h1>
                        <p className="py-6">I am new to redux. In this project I practice CRUD operations using react redux-toolkit. If you want to know more about react-redux please click on get started button.</p>

                        <button className="btn btn-primary" onClick={(e) => {
                            e.preventDefault();
                            window.location.href = 'https://react-redux.js.org/';
                        }}>Get Started</button>
                    </div>
                </div>
            </div>
